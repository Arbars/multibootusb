...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_select_usb_disk.setText(_translate("MainWindow", "<b>Выберите USB диск</b>"))
        self.button_detect_drives.setText(_translate("MainWindow", "Опознать диск"))
        self.checkbox_all_drives.setText(_translate("MainWindow", "Все диски"))
        self.group_usb_details.setTitle(_translate("MainWindow", "Детали устройсква"))
        self.label_usb_dev.setText(_translate("MainWindow", "Диск:"))
        self.label_usb_vendor.setText(_translate("MainWindow", "Вендор:"))
        self.label_usb_model.setText(_translate("MainWindow", "Модель:"))
        self.label_usb_size.setText(_translate("MainWindow", "Размер:"))
        self.label_usb_mount.setText(_translate("MainWindow", "Примонтирован в:"))
        self.label_usb_type.setText(_translate("MainWindow", "Тип:"))
        self.label_usb_fs.setText(_translate("MainWindow", "Файловая система:"))
        self.image_details_group.setTitle(_translate("MainWindow", "Подробно об образе"))
        self.label_image_type.setText(_translate("MainWindow", "Тип:"))
        self.label_image_size.setText(_translate("MainWindow", "Размер:"))
        self.label_image_bootable.setText(_translate("MainWindow", "Загрузочный:"))
        self.button_browse_image.setText(_translate("MainWindow", "Загрузить"))
        self.label_select_image.setText(_translate("MainWindow", "<b>Выбрать образ</b>"))
        self.button_uninstall_distro.setText(_translate("MainWindow", "Удалить дистрибутив"))
        self.button_install_distro.setText(_translate("MainWindow", "Установить дистрибутив"))
        self.slider_persistence.setToolTip(_translate("MainWindow", "Выберите размер Пользовательского раздела (опция активна, если дистрибутив её поддерживает)"))
        self.label_persistence.setText(_translate("MainWindow", "Пользовательский раздел"))
        self.label_persistence_value.setText(_translate("MainWindow", "0 МБ"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_multibootusb), _translate("MainWindow", "MultiBootUSB"))
        self.button_write_image_to_disk.setText(_translate("MainWindow", "Записать образ на USB-диск"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#ff0000;\">ВНИМАНИЕ!</span></p><p align=\"center\"><span style=\" color:#000000;\">Это действие уничтожит </span><span style=\" font-weight:600; color:#000000;\">ВСЕ</span><span style=\" color:#000000;\"> данные на выбранном диске.</span></p><p align=\"center\"><span style=\" color:#000000;\">Пожалуйста, внимательно выбирайте диск для записи.</span></p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_imager), _translate("MainWindow", "Записать образ на диск"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Установить Syslinux"))
        self.check_install_sys_only.setText(_translate("MainWindow", "Установить только syslinu&x (текущие настройки изменены не будут)."))
        self.check_install_sys_all.setText(_translate("MainWindow", "Установить syslinux и скопировать все не&обходимые файлы."))
        self.button_install_syslinux.setText(_translate("MainWindow", "Установить"))
        self.groupBox_3.setTitle(_translate("MainWindow", "syslinux.cfg"))
        self.button_edit_syslinux.setText(_translate("MainWindow", "Изменить"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\">Изменить файл syslinux.cfg в редакторе по-умолчанию. </p><p align=\"justify\">Be <span style=\" font-weight:600; color:#ff0000;\">CAREFUL</span> while editing syslinux.cfg!</p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_syslinux), _translate("MainWindow", "Установить Syslinux"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Загрузочный USB :: Проверить загрузочный USB диск без перезагрузки"))
        self.combo_usb_boot_ram.setItemText(0, _translate("MainWindow", "По-умолчанию"))
        ...
        self.label_4.setText(_translate("MainWindow", "Выберите объём ОЗУ:"))
        self.boot_usb_qemu.setText(_translate("MainWindow", "Загрузить &USB"))
        self.label_5.setText(_translate("MainWindow", "МБ"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Загрузочный ISO :: Запустить загрузочный образ без перезагрузки"))
        self.label_3.setText(_translate("MainWindow", "Выберите объём ОЗУ:"))
        self.boot_iso_qemu.setText(_translate("MainWindow", "Загрузить &образ"))
        self.combo_iso_boot_ram.setItemText(0, _translate("MainWindow", "По-умолчанию"))
        ...
        self.label.setText(_translate("MainWindow", "МБ"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_testboot), _translate("MainWindow", "Загрузить образ/USB-диск"))
